...
export default class Section extends Component {
    ...
    renderRow = (item, index, color) => {
        return (
            ...
            >
                ...
                <View style={item.icon ? styles.value : styles.value_no_icon}>
    ...
    render() {
        const { overrides, theme, title, items } = this.props;
        ...
        const TEXT_COLOR = overrides ? overrides.textStyleMap[theme]['default'] : textStyleMap[theme]['default'];
        const SUB_TEXT_COLOR = overrides ? overrides.subheaderStyleMap[theme] : subheaderStyleMap[theme];
        const ACTIVE_COLOR = overrides ? overrides.activeStyleMap[theme] : activeStyleMap[theme];
